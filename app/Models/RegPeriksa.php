...
class RegPeriksa extends Model
{
	...
	public function getNoRkmMedisAttribute($value)
	{
		return trim($value);
	}
	...
	public function scopeStatus($query, $status = 'Sudah')
	{
	...
	public function skriningTb()
	{
		return $this->hasOne(RsiaSkriningTb::class, 'no_rawat', 'no_rawat');
	}

...
class CreateJnsPerawatanRadiologiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('jns_perawatan_radiologi', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('jns_perawatan_radiologi');
    }
}

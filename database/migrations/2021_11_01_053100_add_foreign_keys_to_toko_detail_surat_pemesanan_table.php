...
class AddForeignKeysToTokoDetailSuratPemesananTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('toko_detail_surat_pemesanan', function (Blueprint $table) {
            ...
            $table->foreign(['kode_sat'], 'toko_detail_surat_pemesanan_ibfk_2')->references(['kode_sat'])->on('kodesatuan')->onUpdate('CASCADE');

...
class CreateTemporaryRadiologiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temporary_radiologi', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('temporary_radiologi');
    }
}

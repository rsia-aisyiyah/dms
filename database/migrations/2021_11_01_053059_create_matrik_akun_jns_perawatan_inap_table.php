...
class CreateMatrikAkunJnsPerawatanInapTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('matrik_akun_jns_perawatan_inap', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('matrik_akun_jns_perawatan_inap');
    }
}

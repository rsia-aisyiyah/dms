...
class CreateDetailSuratPemesananMedisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('detail_surat_pemesanan_medis', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('detail_surat_pemesanan_medis');
    }
}

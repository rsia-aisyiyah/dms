...
class CreatePemeriksaanGinekologiRanapTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pemeriksaan_ginekologi_ranap', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pemeriksaan_ginekologi_ranap');
    }
}

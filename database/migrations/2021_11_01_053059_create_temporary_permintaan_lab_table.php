...
class CreateTemporaryPermintaanLabTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temporary_permintaan_lab', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('temporary_permintaan_lab');
    }
}

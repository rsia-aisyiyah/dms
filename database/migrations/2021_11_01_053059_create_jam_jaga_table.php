...
class CreateJamJagaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('jam_jaga', function (Blueprint $table) {
            $table->integer('no_id', true);
            $table->char('dep_id', 4)->index('dep_id');
            ...
            $table->unique(['dep_id', 'shift'], 'dep_id_2');
        });
    }

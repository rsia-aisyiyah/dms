...
class CreateTemporaryPermintaanRadiologiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temporary_permintaan_radiologi', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('temporary_permintaan_radiologi');
    }
}

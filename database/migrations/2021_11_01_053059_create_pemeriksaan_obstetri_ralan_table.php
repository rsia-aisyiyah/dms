...
class CreatePemeriksaanObstetriRalanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pemeriksaan_obstetri_ralan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pemeriksaan_obstetri_ralan');
    }
}

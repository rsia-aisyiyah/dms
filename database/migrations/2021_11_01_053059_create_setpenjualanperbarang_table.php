...
class CreateSetpenjualanperbarangTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('setpenjualanperbarang', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('setpenjualanperbarang');
    }
}

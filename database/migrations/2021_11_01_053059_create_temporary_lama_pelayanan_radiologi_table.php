...
class CreateTemporaryLamaPelayananRadiologiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temporary_lama_pelayanan_radiologi', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('temporary_lama_pelayanan_radiologi');
    }
}

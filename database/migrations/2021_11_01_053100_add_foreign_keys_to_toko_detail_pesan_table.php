...
class AddForeignKeysToTokoDetailPesanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('toko_detail_pesan', function (Blueprint $table) {
            ...
            $table->foreign(['kode_sat'], 'toko_detail_pesan_ibfk_3')->references(['kode_sat'])->on('kodesatuan')->onUpdate('CASCADE');
        });
    }

...
class CreateTokoSuratPemesananTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('toko_surat_pemesanan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('toko_surat_pemesanan');
    }
}

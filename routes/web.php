...
Route::middleware('auth')->group(function () {
	...
	Route::prefix('grafik')->group(function ($route) {
		$route->prefix('kunjungan')->group(function ($route) {
			...
			$route->get('tahun/{year?}', [RegPeriksaCollection::class, 'getByYear']);

		});
		$route->prefix('penjab')->group(function ($route) {
			$route->get('bpjs/{year?}/{month?}', [PembiayaanPasienCollection::class, 'getPenjabBpjs']);
			$route->get('{year?}/{month?}', [PembiayaanPasienCollection::class, 'getPembiayaan']);
	...
	Route::get('spesialis-poli', [SpesialisController::class, 'getSpesialisPoli']);

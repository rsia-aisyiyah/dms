                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="yearpickerRanap" class="form-control datetimepicker-input"
                                       data-toggle="datetimepicker" aria-describedby="tahun-addon"
                                       data-target="#yearpickerRanap" autocomplete="off"/>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered text-sm" id="tbPasienRanap" style="width: 100%"
                               cellspacing="0">
                            {{-- <tr>
                                    <th>Bulan</th>
                                    <th>Kandungan</th>

                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive text-sm">
                                <table class="table table-bordered table-striped"  id="tabel-ranap" style="width: 100%" cellspacing="0">
                                    <thead>
                                        <tr>
...
<script>
    ...
    $('#pembiayaan').on('change', function(){
        cekTanggal();
        $('#tabel-ranap').DataTable().destroy();
        load_data(tgl_pertama, tgl_kedua, $('#daftar').val(), $('#poli').val(), $('#dokter').val(), $(this).val() );
    });

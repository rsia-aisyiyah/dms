...
<script>
    ...
    var tgl_pertama='', tgl_kedua='', status='', pembiayaan='', spesialis='';
    ...
    $(document).ready(function(){
        ...
        function load_data(tgl_pertama, tgl_kedua, status='', spesialis='', pembiayaan='') {
            ...
            buttons: [
                {extend: 'copy', text:'<i class="fas fa-copy"></i> Salin',className:'btn btn-info', title: 'laporan-10-besar-penyakit-{{date("d F Y")}}'},
                {extend: 'csv',  text:'<i class="fas fa-file-csv"></i> CSV',className:'btn btn-info', title: 'laporan-10-besar-penyakit-{{date("d F Y")}}'},
                {extend: 'excel', text:'<i class="fas fa-file-excel"></i> Excel',className:'btn btn-info', title: 'laporan-10-besar-penyakit-{{date("d F Y")}}'},
            ],
            columns:[

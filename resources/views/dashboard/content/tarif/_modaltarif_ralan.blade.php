                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="custom-select form-control-border poliklinik" id=""
                                    name="poliklinik">
                        ...
                        <div class=" col-sm-4">
                            <div id="form-group">
                                ...
                                <input type="text" value="" id=""
                                    class="form-control tarif_tindakandr" onblur="hitungTarif();cekKosong(this)"
                                    onfocus="removeZero(this)" onkeypress="return hanyaAngka(event)" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div id="form-group">
                                ...
                                <input type="text" value="" id=""
                                    class="form-control tarif_tindakanpr" onblur="hitungTarif();cekKosong(this)"
                                    onfocus="removeZero(this)" onkeypress="return hanyaAngka(event)" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-sm-4">
...
@push('scripts')
    <script>
        function ubahtarif(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('select[name="poliklinik"]').append('<option selected hidden value="' + data[0].poliklinik
                        .kd_poli + '">' + data[0].poliklinik.nm_poli + '</option>');
        ...
        function hitungTarif() {
            ...
            $('.tarif_tindakanpr').val() == '' ? tarif_perawat : tarif_perawat = parseInt($('.tarif_tindakanpr').val());
            $('.tarif_tindakandr').val() == '' ? tarif_dokter = 0 : tarif_dokter = parseInt($('.tarif_tindakandr').val());
            $('.kso').val() == '' ? kso = 0 : kso = parseInt($('.kso').val());
            $('.menejemen').val() == '' ? menejemen = 0 : menejemen = parseInt($('.menejemen').val());

    ...
    function ambilTarif(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('select[name="kamar"]').append('<option selected hidden value="' + data[0].bangsal.kd_bangsal + '">' + data[0].bangsal.nm_bangsal + '</option>');
                $('select[name="kelas"]').append('<option selected hidden value="' + data[0].kelas + '">' + data[0].kelas + '</option>');

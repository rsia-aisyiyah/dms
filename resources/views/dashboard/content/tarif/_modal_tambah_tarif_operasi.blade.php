                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 mb-3">
                            <div id="form-group">
                                ...
                                <input type="text" value="" id="nm_perawatan" class="form-control" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="op1" id="op1" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                            ...
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="op2" id="op2" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="op3" id="op3" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="a_op1" id="a_op1" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="a_op2" id="a_op2" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="a_op3" id="a_op3" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="anes" id="anes" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="a_anes1" id="a_anes1" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="a_anes2" id="a_anes2" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="onloop1" id="onloop1" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="onloop2" id="onloop2" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="onloop3" id="onloop3" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="onloop4" id="onloop4" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="onloop5" id="onloop5" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="bidan1" id="bidan1" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="bidan2" id="bidan2" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="bidan3" id="bidan3" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="dr_anak" id="dr_anak" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="dr_umum" id="dr_umum" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="p_resus" id="p_resus" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="p_luar" id="p_luar" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="sewa" id="sewa" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="sarpras" id="sarpras" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="alat" id="alat" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="bagian" id="bagian" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"
                                        onfocus="removeZero(this)" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="form-group">
                                    ...
                                    <input type="text" value="" name="total" id="total" class="form-control hitung"
                                        onkeypress="return hanyaAngka(event)" onblur="cekKosong(this);hitungOperasi()"

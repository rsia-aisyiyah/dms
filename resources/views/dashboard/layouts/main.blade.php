    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (pushMenuBtn) {
            pushMenuBtn.addEventListener('click', function () {
                // Tunggu sejenak sampai AdminLTE selesai toggle class
                setTimeout(() => {
                    const isCollapsed = document.body.classList.contains('sidebar-collapse');
                    ...
                    // Update indentasi treeview
                    updateTreeviewIndent();
                }, 10);
            });
        }
        ...
        // Panggil fungsi update indentasi saat load
        updateTreeviewIndent();
    });
</script>
